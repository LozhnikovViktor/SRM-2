...
# DaData API
DADATA_API_TOKEN = config('DADATA_API_TOKEN', default='')
...
# 1С API
ONEC_API_URL = config('ONEC_API_URL', default='http://1c-server/hs/api')
ONEC_API_USER = config('ONEC_API_USER', default='')
ONEC_API_PASSWORD = config('ONEC_API_PASSWORD', default='')
# Database
DATABASES = {
    'default': {
...
# ============================================
# 🔹 DaData API (проверка ИНН)
# ============================================
DADATA_API_TOKEN = 'dfb77c9063467adce7f3268376b5d56e2bd2c2ee'
DADATA_SECRET = '50539ced8bb3eb2a08a150a3bf2e5868230535e0'